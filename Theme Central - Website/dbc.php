...
define ("DB_HOST", "pdb1.awardspace.com"); // set database host
define ("DB_USER", "pcx_the1template"); // set database user
define ("DB_PASS","the1test"); // set database password
define ("DB_NAME","pcx_the1template"); // set database name
...
define("COOKIE_TIME_OUT", 14); //specify cookie timeout in days (default is 10 days)
...
/*************** reCAPTCHA KEYS****************/
$publickey = "6Lfi-vQSAAAAAFOczaphH1K5UmscCCkUApCbyKcw";
$privatekey = "6Lfi-vQSAAAAAJOuknKwZAlV-tVHY5-KU2YdX6Y_";
